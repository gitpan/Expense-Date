# This Makefile is for the Expense::Date extension to perl.
#
...
#     ABSTRACT => q[The great new Expense::Date!]
#     AUTHOR => q[STKEVIN <zard1989@gmail.com>]
#     DIR => []
#     DISTNAME => q[Expense-Date]
#     NAME => q[Expense::Date]
#     NO_META => q[1]
#     PL_FILES => {  }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Expense/Date.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Expense
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Expense
...
TO_INST_PM = lib/Expense/.Date.pm.swp \
	lib/Expense/Date.pm

PM_TO_BLIB = lib/Expense/Date.pm \
	blib/lib/Expense/Date.pm \
	lib/Expense/.Date.pm.swp \
	blib/lib/Expense/.Date.pm.swp
...
DISTNAME = Expense-Date
DISTVNAME = Expense-Date-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Expense/Date.pm $(INST_MAN3DIR)/Expense::Date.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new Expense::Date!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>STKEVIN &lt;zard1989@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Expense/Date.pm blib/lib/Expense/Date.pm \
	  lib/Expense/.Date.pm.swp blib/lib/Expense/.Date.pm.swp 
